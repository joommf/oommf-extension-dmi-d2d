...
OXS_EXT_REGISTER(Oxs_DMI_D2d_z);

/* End includes */


// Constructor
Oxs_DMI_D2d_z::Oxs_DMI_D2d_z(
 ...
 ) const
{
  ...
  if(mesh_id !=  state.mesh->Id() || !atlaskey.SameState()) {
	...
	String msg = String("Import mesh to Oxs_DMI_D2d_z::GetEnergy()"
                            " routine of object ")
          + String(InstanceName())
