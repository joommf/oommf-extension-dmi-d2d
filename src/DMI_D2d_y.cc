...
OXS_EXT_REGISTER(Oxs_DMI_D2d_y);

/* End includes */


// Constructor
Oxs_DMI_D2d_y::Oxs_DMI_D2d_y(
 ...
 ) const
{
  ...
  if(mesh_id !=  state.mesh->Id() || !atlaskey.SameState()) {
	...
	String msg = String("Import mesh to Oxs_DMI_D2d_y::GetEnergy()"
                            " routine of object ")
          + String(InstanceName())
